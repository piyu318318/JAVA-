...
order then the inversion count is the maximum. Formally, two elements a[i] and a[j] form an 
...
class CountInversions
{
	...
	{
		int arr[] = {2, 4, 1, 3, 5};
		//int arr[] ={10,10,10};//count must come 0
		//int arr[] = {2, 3, 4, 5, 6};//count must come 0
		int count=0;
